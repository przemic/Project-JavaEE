...
public class CommentController implements Serializable {
    ...
    @EJB
    private com.project.fascades.CommentFacade ejbFacade;
    ...
    public static class CommentControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Comment) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + CommentController.class.getName());
            }
        }
    }
}
